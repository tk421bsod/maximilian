...
class userinfo(commands.Cog):
    ...
    async def userinfo(self, ctx):
        ...
        embed.add_field(name="Date joined:", value=requested_user.joined_at.astimezone('US/Pacific').strftime("%B %d, %Y at %-I:%M %p PST"), inline=False)
        embed.add_field(name="Date created:", value=requested_user.created_at.astimezone('US/Pacific').strftime("%B %d, %Y at %-I:%M %p PST"), inline=False)
