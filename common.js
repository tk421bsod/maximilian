...
function save(path, database, table, valuenodupe, valueallnum, valueallnumenabled, debug){
    ...
    var otherparams = "path=" + path + "&database=" + database + "&table=" + table + "&valuenodupe=" + valuenodupe + "&debug=" + debug + "&valueallnum=" + valueallnum + "&valueallnumenabled=" + valueallnumenabled + "&currentdomain=" + window.location.href.replace("/other-projects/maximilian/", "").replace("http://", "").substring(0, currenturl.length - 1)
