...
* core.py - various utility commands, hooks for on_message, guild_join, and guild_remove, a couple helper methods
* components.py - provides some useful things to modules
...
* README.md - description of the bot, branch info, patch notes for the most recent major release
...
This places your repository into a 'detached HEAD' state that doesn't allow most operations.
