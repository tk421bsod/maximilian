...
class misc(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        embed.add_field(name="Latest update - v1.0.4 (Jan 31, 2023)", value="Some additional bug fixes.\nWant to see changes from the last few updates? Use the `news` command.")
